...
declare const terminalImage: {
	...
	*/
	...
	/**
	Display images in the terminal synchronously.
	...
	const body = await got('https://sindresorhus.com/unicorn').buffer();
	console.log(terminalImage.bufferSync(body));
	console.log(terminalImage.bufferSync(body, {width: '50%', height: '50%'}));
	console.log(terminalImage.bufferSync(body, {width: 50 }));
	console.log(terminalImage.bufferSync(body, {width: 70, height: 50, preserveAspectRatio: false}));
	```
	*/
	bufferSync: (imageBuffer: Readonly<Buffer>, options?: Readonly<{
		width?: string | number;
		height?: string | number;
		preserveAspectRatio?: boolean;
	}>) => string;
	...
	/**
	Display images in the terminal synchronously. Please note that the image will always be scaled to fit the size of the terminal.
	...
	console.log(terminalImage.fileSync('unicorn.jpg'));
	console.log(terminalImage.fileSync('unicorn.jpg', {width: '50%', height: '50%'}));
	console.log(terminalImage.fileSync('unicorn.jpg', {width: 50 }));
	console.log(terminalImage.fileSync('unicorn.jpg', {width: 70, height: 50, preserveAspectRatio: false}));
	```
	*/
	fileSync: (
		filePath: string,
